...
namespace Engine.Models
{
    public class Inventory
    {
        ...
        [JsonIgnore]
        public IReadOnlyList<GameItem> Weapons => _backingInventory.ItemsThatAre(ItemCategory.Weapon).AsReadOnly();
        [JsonIgnore]
        public IReadOnlyList<GameItem> Consumables => _backingInventory.ItemsThatAre(ItemCategory.Consumable).AsReadOnly();
        [JsonIgnore]
